...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<BusinessExceptionResponse<Object>> handleBusinessException(BusinessException e) {
        var response = BusinessExceptionResponse.builder()
                .code(e.getCode())
    ...
    public ProblemDetail handleBadCredentials(BadCredentialsException ex) {
        return buildProblemDetail(HttpStatus.UNAUTHORIZED, ex.getMessage(), "The username or password is incorrect");
    }
